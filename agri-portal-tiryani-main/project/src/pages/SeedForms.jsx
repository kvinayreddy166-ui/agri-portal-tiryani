...
function drawSeedFormII(doc, form) {
  ...
  details(doc, p, [
    ...
    ['8. Name and designation of the person who sends the sample', formatAddressLinesWithPunctuation(r.fromAddress)],
  ]);
...
function formatAddressLinesWithPunctuation(value) {
...
function drawFromTo(doc, p, r) {
  ...
  doc.text('To:', 128, p.y);
  doc.text(doc.splitTextToSize(formatAddressLinesWithPunctuation(r.fromAddress) || '________________', 78), 20, p.y + 7);
