-- Remote Sensing / Crop Health optional PostGIS schema documentation.
-- This migration is intentionally non-executing so existing Supabase tables,
-- auth, fertilizer calculator, farmer database, dealer stock, and toolkit modules remain untouched.
-- To enable later live Sentinel-2 / Sentinel-1 / Google Earth Engine integration,
-- review and apply the suggested schema manually in a controlled migration.
