...
export const initialPesticidePdfValues: PesticidePdfValues = {
  ...
  officeAddress: 'Mandal: Tiryani\nDist: Kumuram Bheem Asifabad',
  officerEmail: 'k.vinayreddy166@gmail.com',
  district: 'Kumurambheem Asifabad',
  mandal: 'Tiryani',
  place: 'Tiryani',
  ...
  manufactureDate: '',
  expiryDate: '',
  packingCondition: 'Original sealed',
  sampleQuantity: '',
