    ...
    risks: [
      {
        type: 'Pest',
        name: 'Thrips',
        symptoms: 'Silvery streaks on leaves, curled tips, and distorted growth.',
        action: 'Avoid early season planting, monitor seedlings, and spray recommended insecticides at ETL.',
      ...
      },
      {
        type: 'Pest',
        name: 'Gall Midge',
        symptoms: 'Silver shoot or onion leaf symptoms due to gall formation at growing tip.',
        action: 'Use early-maturing varieties, avoid late planting, and remove galls manually.',
        image: 'https://images.unsplash.com/photo-1628155930542-3c7a64e2c833?auto=format&fit=crop&q=80&w=600',
      },
      {
        type: 'Pest',
        name: 'Leaf Folder',
        symptoms: 'Leaves folded and stitched together with larvae feeding inside.',
        action: 'Use pheromone traps, conserve natural enemies, and need-based spraying.',
        image: 'https://images.unsplash.com/photo-1551754655-cd27e38d2076?auto=format&fit=crop&q=80&w=600',
      },
      {
        type: 'Pest',
        name: 'Yellow Stem Borer',
        symptoms: 'Dead hearts in vegetative stage and white heads at reproductive stage.',
        action: 'Use pheromone traps, clip dead hearts, and apply granules in whorl at recommended time.',
