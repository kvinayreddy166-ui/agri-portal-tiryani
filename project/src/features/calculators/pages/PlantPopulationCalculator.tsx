...
function FormSection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="rounded-xl border-2 border-green-300 bg-gradient-to-br from-white via-green-50 to-lime-100 p-4 shadow-md dark:border-green-900/60 dark:from-slate-900 dark:via-green-950/30 dark:to-lime-950/20">
...
const inputClass = 'min-h-11 w-full rounded-lg border-2 border-green-300 bg-white/85 px-3 py-2 text-sm font-bold text-slate-950 outline-none transition focus:border-green-500 focus:bg-white focus:ring-4 focus:ring-green-100 dark:border-green-900 dark:bg-slate-950 dark:text-white dark:focus:ring-green-900/40';
