...
const QualityControl = lazy(() => import('../features/quality-control/pages/QualityControl').then((m) => ({ default: m.QualityControl })));
const QualityControlHub = lazy(() => import('../features/quality-control/pages/QualityControlHub').then((m) => ({ default: m.QualityControlHub })));
const FarmMechanization = lazy(() => import('../features/schemes/pages/FarmMechanization').then((m) => ({ default: m.FarmMechanization })));
const GosCirculars = lazy(() => import('../features/documents/pages/GosCirculars').then((m) => ({ default: m.GosCirculars })));
const FileDirectory = lazy(() => import('../features/documents/pages/FileDirectory').then((m) => ({ default: m.FileDirectory })));
const SubsidyTracking = lazy(() => import('../features/schemes/pages/SubsidyTracking').then((m) => ({ default: m.SubsidyTracking })));
const DealerStockPortal = lazy(() => import('../features/dealer-stock/pages/DealerStockPortal').then((m) => ({ default: m.DealerStockPortal })));
const AcreageCalculator = lazy(() => import('../features/calculators/pages/AcreageCalculator').then((m) => ({ default: m.AcreageCalculator })));
const FertilizerCalculator = lazy(() => import('../features/calculators/pages/FertilizerCalculator').then((m) => ({ default: m.FertilizerCalculator })));
...
const FarmCalculators = lazy(() => import('../features/calculators/pages/FarmCalculators').then((m) => ({ default: m.FarmCalculators })));
const CropProtectionTool = lazy(() => import('../features/crop-doctor/CropProtectionTool').then((m) => ({ default: m.CropProtectionTool })));
const PesticideCalculator = lazy(() => import('../features/calculators/pages/PesticideCalculator').then((m) => ({ default: m.PesticideCalculator })));
const PlantPopulationCalculator = lazy(() => import('../features/calculators/pages/PlantPopulationCalculator').then((m) => ({ default: m.PlantPopulationCalculator })));
const SeedRateCalculator = lazy(() => import('../features/calculators/pages/SeedRateCalculator').then((m) => ({ default: m.SeedRateCalculator })));
...
const OfficerContacts = lazy(() => import('../features/contacts/pages/OfficerContacts').then((m) => ({ default: m.OfficerContacts })));
const OfficerContactsAdmin = lazy(() => import('../features/contacts/pages/OfficerContactsAdmin').then((m) => ({ default: m.OfficerContactsAdmin })));
const TourDiary = lazy(() => import('../features/tour-diary/pages/TourDiary').then((m) => ({ default: m.TourDiary })));
const SeedDealerInspection = lazy(() => import('../features/officers-toolkit/pages/SeedDealerInspection').then((m) => ({ default: m.SeedDealerInspection })));
