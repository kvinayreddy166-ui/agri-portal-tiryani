      ...
      <div className="flex max-h-[94vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        <header className="relative flex shrink-0 flex-wrap items-start justify-between gap-3 border-b border-amber-100/50 bg-gradient-to-r from-amber-50 via-white to-yellow-50 px-4 py-4 sm:px-6 sm:py-5 backdrop-blur-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[10px] font-black uppercase tracking-widest text-amber-700">Pesticide Sampling</p>
        ...
        <div className="flex min-h-0 flex-1 overflow-hidden">
          <div className="flex min-h-0 flex-1 flex-col overflow-y-auto p-4 sm:p-6">
            {message && (
              <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 text-sm font-bold text-amber-800">
                {message}
              </div>
            )}
            ...
            <div className="rounded-xl shadow-sm border border-amber-200 bg-amber-50/50 p-1 sm:p-6">
