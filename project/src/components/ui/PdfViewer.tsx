...
export function PdfViewer({ pdfData, onError, onLoadComplete }: PdfViewerProps) {
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Unable to display PDF preview</h3>
  ...
  return (
    <div 
      ...
      className="w-full h-full overflow-y-auto p-4 bg-gray-100 dark:bg-slate-800"
      style={{ height: '100%' }}
    >
